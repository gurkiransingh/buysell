...
class Item extends React.Component {
    ...
    deleteItemFromCart() {
        this.props.fetchUpdated(this.props.item, this.props.size);
    }
        ...
        return (
            <div className='item'>
                ...
                <div className='desc'>
                    ...
                    <p className='sizes'> Available in 
                        {
                        this.props.item.size.map((v, i)=> {
                            return (<span className='size' key={i}>{v}</span>)
                        })
                        }
                    </p>
                    {
                        this.props.size && <p>You selected {this.props.size}</p>
                    }
